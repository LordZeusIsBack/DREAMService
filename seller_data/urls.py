...
urlpatterns = [
    ...
    path('forgot-password/', views.seller_forgot_password, name='forgot_seller_password'),
    path('reset-password/', views.seller_reset_password, name='reset_seller_password'),
