...
class EstateAdmin(admin.ModelAdmin):
    ...
    def image_preview(self, obj):
        """
        Returns an HTML image preview for the object's image field in the Django admin list view.
        
        If the object has an associated image, displays a scaled preview; otherwise, shows "No Image".
        """
        if obj.image:
