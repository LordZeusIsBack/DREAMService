...
class CustomUserManager(BaseUserManager):
    def create_user(self, email, username, password=None, **extra_fields):
        """
        Creates and saves a new user with the specified email, username, and password.
    ...
    def create_superuser(self, email, username, password=None, **extra_fields):
        """
        Creates and returns a superuser with the specified email, username, and password.
        
        Ensures that the created user has both is_staff and is_superuser set to True. Raises a ValueError if these conditions are not met.
        """
...
class CustomUser(AbstractBaseUser, PermissionsMixin):
    ...
    def __str__(self):
        """
        Returns the user's email address as its string representation.
        """
        return self.email
